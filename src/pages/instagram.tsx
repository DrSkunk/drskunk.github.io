  ...
  return (
    <Layout color="#3F4F67">
      ...
      >
        <h1>Instagram</h1>
        <p>
          On my Instagram page I try to post regular updates on the projects I'm
          working on, as well as the results of the smaller projects I do.
        </p>
        <p>
          This feed is directly taken from{' '}
          <a href="https://instagram.com/ikbensebastiaan/">my instagram page</a>
          , where you can follow me in a non-stalkery way.
        </p>
      </AnimatedBox>
